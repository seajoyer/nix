...
pname = "paraview";
  ...
  postPatch = ''
    ...
    # Force Qt to use Wayland platform instead of XCB (X11) fallback.
    # Original: std::string platform_args_data[] = { "-platform", "xcb" };
    substituteInPlace CMake/paraview_client_main.cxx.in \
      --replace-fail 'std::string platform_args_data[] = { "-platform", "xcb" };' \
  ...
  propagatedBuildInputs = [
    ...
    qt6Packages.qtwayland  # Add this for Wayland platform plugin support
    protobuf
    vtk-full
  ];
